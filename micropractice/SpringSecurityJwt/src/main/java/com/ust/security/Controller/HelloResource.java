...
public class HelloResource {
	...
	//use user service method of overriding the default behavior, creating user data service which returns a static user 

	@PostMapping("/authenticate")
	//takes username and password as input and returns jwt token
